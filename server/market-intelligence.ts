...
const MARKET_BENCHMARKS: MarketData = {
  ...
  tiers: [
    {
      ...
      priceRange: { min: 250, max: 375 },
      description: "První nákup — filtruje neplatiče. Nesnižuj pod 250 Kč. Testuj 299/349/375.",
  ...
  benchmarks: {
    avgConversionRate: 5,
    avgFirstPurchase: 300,
    avgRepeatPurchase: 750,
    avgLifetimeValue: 6000,
    optimalFirstOffer: { min: 250, max: 375 },
  },
  trendingContent: [
